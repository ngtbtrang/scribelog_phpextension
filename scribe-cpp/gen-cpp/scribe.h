...
class scribe_Log_args {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const scribe_Log_args& obj);
};
...
class scribe_Log_pargs {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const scribe_Log_pargs& obj);
};
...
class scribe_Log_result {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const scribe_Log_result& obj);
};
...
class scribe_Log_presult {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const scribe_Log_presult& obj);
};
