...
interface scribeIf extends \facebook\fb303\FacebookServiceIf {
  /**
   * @param \scribe\thrift\LogEntry[] $messages
   * @return int
   */
  public function Log(array $messages);
}

class scribeClient extends \facebook\fb303\FacebookServiceClient implements \scribe\thrift\scribeIf {
  ...
  public function recv_Log()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\scribe\thrift\scribe_Log_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \scribe\thrift\scribe_Log_result();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \scribe\thrift\LogEntry();
